	...
	TestTCPEvents := func() {
		Context("TCP Events", func() {
			...
			BeforeEach(func() {
				...
				route1 = models.NewTcpRouteMapping(routerGroupGuid, 3000, "1.1.1.1", 1234, 1235, "", nil, nil, 60, models.ModificationTag{}, false, "")
			...
			It("gets events for updated routes", func() {
				...
				go func() {
					defer close(done)
					routeUpdated := models.NewTcpRouteMapping(routerGroupGuid, 3000, "1.1.1.1", 1234, 1235, "", nil, nil, 75, models.ModificationTag{}, false, "")
			...
			It("gets events for expired routes", func() {
				routeExpire := models.NewTcpRouteMapping(routerGroupGuid, 3000, "1.1.1.1", 1234, 1235, "", nil, nil, 1, models.ModificationTag{}, false, "")
		...
		Context("TCP Routes", func() {
			...
			Context("POST", func() {
				It("allows to create given tcp route mappings", func() {
					var err error
					tcpRouteMapping1 = models.NewTcpRouteMapping(routerGroupGuid, 52000, "1.2.3.4", 60000, 60002, "", nil, nil, 60, models.ModificationTag{}, false, "")
					tcpRouteMapping2 = models.NewTcpRouteMapping(routerGroupGuid, 52001, "1.2.3.5", 60001, 60003, "", nil, nil, 3, models.ModificationTag{}, true, "alpn1,alpn2")
				...
				Context("when tcp route mappings already exist", func() {
					BeforeEach(func() {
						var err error
						tcpRouteMapping1 = models.NewTcpRouteMapping(routerGroupGuid, 52000, "1.2.3.4", 60000, 60001, "", nil, nil, 60, models.ModificationTag{}, true, "alpn1,alpn2")
