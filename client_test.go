...
var _ = Describe("Client", func() {
	...
	Context("UpsertTcpRouteMappings", func() {
		...
		BeforeEach(func() {
			tcpRouteMapping1 = models.NewTcpRouteMapping("router-group-guid-001", 52000, "1.2.3.4", 60000, 60002, "", nil, nil, 60, models.ModificationTag{}, false, "")
			tcpRouteMapping2 = models.NewTcpRouteMapping("router-group-guid-001", 52001, "1.2.3.5", 60001, 60003, "", nil, nil, 60, models.ModificationTag{}, true, "alpn1,alpn2")
		})
	...
	Context("DeleteTcpRouteMappings", func() {
		...
		BeforeEach(func() {
			tcpRouteMapping1 = models.NewTcpRouteMapping("router-group-guid-001", 52000, "1.2.3.4", 60000, 60002, "", nil, nil, 60, models.ModificationTag{}, false, "")
			tcpRouteMapping2 = models.NewTcpRouteMapping("router-group-guid-001", 52001, "1.2.3.5", 60001, 60003, "", nil, nil, 60, models.ModificationTag{}, false, "")
		})
		JustBeforeEach(func() {
	...
	Context("SubscribeToTcpEvents", func() {
		...
		BeforeEach(func() {
			tcpRoute1 = models.NewTcpRouteMapping("rguid1", 52000, "1.1.1.1", 60000, 60002, "", nil, nil, 60, models.ModificationTag{}, false, "alpn1,alpn2")
