...
//counterfeiter:generate -o fake_routing_api/fake_event_source.go . EventSource
...
//counterfeiter:generate -o fake_routing_api/fake_tcp_event_source.go . TcpEventSource
