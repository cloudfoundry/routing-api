...
func (fake *FakePartialStatsdClient) Gauge(arg1 string, arg2 int64, arg3 float32) error {
...
func (fake *FakePartialStatsdClient) GaugeCalls(stub func(string, int64, float32) error) {
	fake.gaugeMutex.Lock()
...
func (fake *FakePartialStatsdClient) GaugeDelta(arg1 string, arg2 int64, arg3 float32) error {
...
func (fake *FakePartialStatsdClient) GaugeDeltaCalls(stub func(string, int64, float32) error) {
	fake.gaugeDeltaMutex.Lock()
